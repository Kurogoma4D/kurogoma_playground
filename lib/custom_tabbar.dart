...
class _TabBarScrollPosition extends ScrollPositionWithSingleContext {
  ...
  final _InfiniteScrollTabBarState tabBar;
...
class InfiniteScrollTabBar extends StatefulWidget
  ...
  /// and the entire [InfiniteScrollTabBar] is scrollable. Otherwise each tab gets an equal
  ...
  /// An optional callback that's called when the [InfiniteScrollTabBar] is tapped.
  ///
  ...
  /// How the [InfiniteScrollTabBar]'s scroll view should respond to user input.
  ///
  ...
  @override
  _InfiniteScrollTabBarState createState() => _InfiniteScrollTabBarState();
}

class _InfiniteScrollTabBarState extends State<InfiniteScrollTabBar> {
  ...
  @override
  void didUpdateWidget(InfiniteScrollTabBar oldWidget) {
